...
def main(args):
    train_dataset = get_data(data_name = args.dataset_name, usage = args.table_mode)
    # if args.table_mode == 'hightlight_evi': 
    #     train_dataset = get_data(data_name = args.dataset_name, usage = 'train_highlight_evi', info='p0')
    ...
    results_dir = f"experiments/{mname}-{args.dataset_name}_epochs-{args.epochs}_rank-{args.lora_r}_table-{args.table_mode}"
    print(results_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", default="fetaqa")
